#execute if entity @s[type=minecraft:creeper] run function mob:creeper
...
#execute if entity @s[type=#main:web_thrower] run function mob:web_thrower
...
execute if entity @s[type=#main:vortex_maker,tag=!PlayerTargeted] run function mob:vortex_maker
